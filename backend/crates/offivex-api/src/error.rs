...
use offivex_core::token::mint::MintError;
use offivex_core::bundle::builder::BundleError;
use offivex_core::distribution::disperser::DistributionError;
use offivex_core::token::vanity::VanityError;
use offivex_core::meme::manager::MemeError;
...
impl From<offivex_db::DbError> for AppError {
    fn from(e: offivex_db::DbError) -> Self {
