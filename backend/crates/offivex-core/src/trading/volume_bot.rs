...
/// The `keypair` is a [`ZeroizingKeypair`] (SEC-2): its secret bytes are zeroed
/// when the WalletState (and thus the bot) is dropped.
struct WalletState {
    id: String,
    keypair: crate::wallet::ZeroizingKeypair,
    token_balance: u64,
