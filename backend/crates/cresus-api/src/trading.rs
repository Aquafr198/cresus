...
use cresus_core::trading::{VolumeBot, VolumeBotConfig, BumperBot, BumperBotConfig};
...
pub async fn execute_swap(
    ...
    let signature = if direction == "buy" {
        ...
        cresus_core::trading::swap::swap_sol_to_token(
            &keypair,
            &token_pubkey,
            sol_lamports,
            body.slippage_bps,
        ...
        cresus_core::trading::swap::swap_token_to_sol(
            &keypair,
            &token_pubkey,
            token_amount,
            body.slippage_bps,
...
pub async fn execute_pump_fun_launch(
    ...
    let creator_keypair = cresus_core::wallet::decrypt::decrypt_wallet_keypair(
        &state.db,
        &creator_wallet_id,
        &mek,
    )
    ...
    // Build launch config
    let config = cresus_core::trading::pump_fun::PumpFunLaunchConfig {
        name: token_name,
        symbol: token_symbol,
    ...
    // Execute on-chain
    match cresus_core::trading::pump_fun::create_pump_fun_token(
        &creator_keypair,
        &config,
        &rpc_client,
    )
...
pub async fn buy_pump_fun_token(
    ...
    let signature = cresus_core::trading::pump_fun::buy_pump_fun_token(
        &keypair,
        &token_pubkey,
        sol_lamports,
        body.slippage_bps,
...
pub async fn sell_pump_fun_token(
    ...
    let signature = cresus_core::trading::pump_fun::sell_pump_fun_token(
        &keypair,
        &token_pubkey,
        token_amount,
        body.slippage_bps,
