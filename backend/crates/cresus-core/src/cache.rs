...
/// Centralized cache for the Cresus platform.
#[derive(Clone)]
pub struct CresusCache {
...
pub fn create_cache() -> Arc<CresusCache> {
    Arc::new(CresusCache::new())
}
